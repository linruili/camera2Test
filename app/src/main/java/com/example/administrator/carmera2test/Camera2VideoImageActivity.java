package com.example.administrator.carmera2test;
...
public class Camera2VideoImageActivity extends AppCompatActivity {
    ...
    private TextureView.SurfaceTextureListener mSurfaceTextureListener = new TextureView.SurfaceTextureListener() {
        ...
        public void onSurfaceTextureUpdated(SurfaceTexture surface) {
            ...
            {
                ff += 1;
                Log.d("MainActivity", "onSurfaceTextureUpdated  " + ff);
...
//                Bitmap bmp = Bitmap.createBitmap(mTextureView.getWidth(), mTextureView.getHeight(), Bitmap.Config.ARGB_8888);
                ...
                mBackgroundHandler.post(new BitmapSaver(bmp));
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener = new
            ImageReader.OnImageAvailableListener() {
                ...
                public void onImageAvailable(ImageReader reader) {
                    Log.d("MainActivity", "image available");
//                    mBackgroundHandler.post(new ImageSaver(reader.acquireLatestImage()));
    ...
    private class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            try {
                Log.d("MainActivity", "saving images");
...
//                                        CaptureRequest.CONTROL_AE_MODE_OFF);
    ...
    private void startStillCaptureRequest() {
        Log.d("MainActivity", "in startStillCaptureRequest method");
        try {
            if(mIsRecording)
